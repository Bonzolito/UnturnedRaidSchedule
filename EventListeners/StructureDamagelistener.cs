...
{
    public class StructureDamageListener : IEventListener<UnturnedStructureDamagingEvent>
    {
        ...
        public StructureDamageListener(
        ...
        public Task HandleEventAsync(object? sender, UnturnedStructureDamagingEvent @event)
        {
            ...
            if (!cfg.Blocking.Structures) return Task.CompletedTask;
            ...
            // Allow self-damage (player demolishing their own builds)
